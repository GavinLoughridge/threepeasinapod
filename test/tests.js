...
const podFunction = require('../src/main');
...
//     expect(podFunction.getValue(dice(.1))).to.equa(1);
//   })
//
//   it("returns the value associated with the side", function() {
//     expect(podFunction.getValue(dice(.7))).to.equal("Pick a number 1-6");
//   })
// })
//
//
...
//   })
//   it("returns the image associated with the side", function() {
//     expect(podFunction.getImage(dice(.7))).to.equal("Pick a number 1-6")
//   })
// })
